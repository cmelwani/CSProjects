                ...
                A2Methods_Object *elem, void *dctQuantized) 
{
    ...
    codeword = Bitpack_news(codeword, 5, 8, currPix->d);
    codeword = Bitpack_news(codeword, 5, 13, currPix->c);
    codeword = Bitpack_news(codeword, 5, 18, currPix->b);
    codeword = Bitpack_newu(codeword, 9, 23, currPix->a);
                ...
                A2Methods_Object *elem, void *dctQuantized) 
{
    ...
    currPix->d = Bitpack_gets(word, 5, 8);
    currPix->c = Bitpack_gets(word, 5, 13);
    currPix->b = Bitpack_gets(word, 5, 18);
    currPix->a = Bitpack_getu(word, 9, 23);
