...
int main()
{
	...
	const int shift_amount = 5;
	string word_to_encrypt;

	// Get the word to encrypt from the user
	cout << "Please ensure that you enter the world you intend to incrypt (in lower case letters !!)";
	cout << endl;
	...
	cout << "Here is the genius outcome of what is not my code (btw its the encrypted word): ";
